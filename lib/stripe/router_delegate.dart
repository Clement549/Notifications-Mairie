...
import 'package:flutter_course/stripe/back_dispatcher.dart';
...
import 'package:flutter_course/stripe/register-success.dart';
  ...
  void addPage(PageConfiguration pageConfig) {
    ...
    if (shouldAddPage) {
      switch (pageConfig.uiPage) {
        case Pages.Home:
          _pages.add(
            _createPage(HomePage(title: 'Panda Gums'), pageConfig),
          );
          break;
        case Pages.Register:
          _pages.add(
