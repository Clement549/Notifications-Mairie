...
class ProfilImageState extends State<ProfilImage> {
  ...
  Future _pickImage(ImageSource source) async {
    ...
    if(!kIsWeb){
      ...
      var file = await ImageCropper.cropImage(sourcePath: pickedFile.path, cropStyle: CropStyle.circle, aspectRatio: const CropAspectRatio(ratioX: 1, ratioY: 1)); //aspectRatio: const CropAspectRatio(ratioX: 1, ratioY: 1)
